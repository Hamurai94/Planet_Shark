...
// Using a namespace object to prevent redeclaration conflicts with simple_data.js
...
// @ts-ignore - Intentional redeclaration for backward compatibility
const SHARKANOID_TEMPLATES = window.GameData.SHARKANOID_TEMPLATES;
// @ts-ignore - Intentional redeclaration for backward compatibility
const WEAPONS = window.GameData.WEAPONS;
// @ts-ignore - Intentional redeclaration for backward compatibility
const EQUIPMENT = window.GameData.EQUIPMENT;
// @ts-ignore - Intentional redeclaration for backward compatibility
const EXTRAS = window.GameData.EXTRAS;
// @ts-ignore - Intentional redeclaration for backward compatibility
const SPECIAL_RULES = window.GameData.SPECIAL_RULES;
// @ts-ignore - Intentional redeclaration for backward compatibility
const HONORS = window.GameData.HONORS;